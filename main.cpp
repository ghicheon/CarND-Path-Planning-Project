                ...
                {                                                                           \
                        ...
                        {                                                                   \
                                ...
                                {                                                           \
                                    ...
                                    {                                                       \
                                            right_ok = 0;                                   \
cout << "\n(can't be RIGHT ---  right car is aproching fast!" << endl; \
                                    }                                                       \
                                                                                            \
                                }                                                           \
                                                                                            \
                ...
                {                                                                           \
                        ...
                        {                                                                   \
                                ...
                                {                                                           \
                                    if(( s > car_s) && (( s - car_s) < 30) )                \
                                    {                                                       \
cout << "\n(can't be LEFT ---  left car is aproching fast!" << endl ; \
                                            left_ok = 0;                                    \
                                    }                                                       \
                                }                                                           \
                        }                                                                   \
...
cout << "\nXXXXXXX " <<  left_ok << "  " << right_ok << " " << left_speed << " " << right_speed << " " << car_speed << endl ;\
            ...
            {                                                                               \
                if( left_speed == right_speed  ) /*XXX*/ \
                {\
                    new_state =  KEEP;                                                      \
                }\
                else if( left_speed > right_speed &&  left_speed > car_speed )                   \
                {                                                                           \
                    new_state =   LEFT;                                                     \
                }                                                                           \
...
cout << "\nXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX" << max_speed << endl;
                                                     break;
                                                default:
                                                     assert(0);
                                                     break;
